...
//    {
//        public async Task<JobApplicationDto> ApplyJobApplicationAsync(int jobId, int candidateId)
//        {
...
//        public async Task<JobApplicationDto> GetMyApplicationByIdAsync(int applicationId, int candidateId)
//        {
//            var application = await _unitOfWork.GetRepository<JobApplication>().GetByIdAsync(applicationId); 
//            if (application is null) 
//                throw new NotFoundException("Application not found."); 
